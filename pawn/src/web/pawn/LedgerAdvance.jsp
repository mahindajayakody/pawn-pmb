...
<html:html>
			...
			function printDocument(){
				...
				if(branchId>0){	
					if(	fromDates.length == 0  || toDates.length == 0){
						...
						url = "pawningTransaction.do?dispatch=print&reportName=/pawn/reports/LedgerAdvance&headless=false"+
	...
	<body>
		<h1 align="center">Ledger Advance Report</h1>
