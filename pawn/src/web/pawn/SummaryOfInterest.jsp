...
<html:html>
	<head>
		<title>'SummaryOfInterest.jsp'</title>
		...
		<script type="text/javascript">
			...
			function printDocument(){
				...
				if(branchId>0){	
					url = "summaryOfInterest.do?dispatch=print&reportName=/pawn/reports/summaryOfInterest&headless=false"+
						  "&jpFromDate=" + $('fromDate').value + "&jpToDate=" + $('toDate').value + 
						  "&jpIntBranchId=" + $('branchId').value;	
	...
	<body>
		<h1 align="center">Summary Of Interest Report</h1>
