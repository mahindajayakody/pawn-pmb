...
<html:html>
  	<head>
		...
		<script type="text/javascript">								
			var url = 'cartageMarsterService.do';
  	...
  	<body onload="loadToolBar()">
    	...
    	<!-- Create record -->
    	<logic:equal name="cartagemarster" property="action" value="create">
			<html:form action="cartageMarsterService.do">
						...
						<td>							
							<table class="InputTable">    
								...
								<tr>
									...
									<td>
										<html:text property="code" styleId="code" size="6" maxlength="3"
    	...
    	<!-- update record -->
    	<logic:equal name="cartagemarster" property="action" value="update">
						...
						<td>							
							<table class="InputTable">    
								...
								<tr>
									...
									<td>
										<html:text property="code" styleId="code" size="6" maxlength="3" disabled="true" styleClass="READONLYINPUT"
											onblur="upperCase('code')" onfocus="clearDivision('divCode')"/>										
											<font color="red">*</font><br/>
											<div id="divCode" class="validate"/>
									</td>
    	...
    	<!-- Delete record -->
    	<logic:equal name="cartagemarster" property="action" value="delete">
						...
						<td>							
							<table class="InputTable">    
								...
								<tr>
									...
									<td>
										<html:text property="code" styleId="code" size="6"  readonly="true" styleClass="READONLYINPUT"
								...
								<tr>
									...
									<td>
										<html:text property="description" styleId="description" size="70" readonly="true" styleClass="READONLYINPUT"
											onfocus="clearDivision('divDescription')"/>										
										<font color="red">*</font><br/>
										<div id="divDescription" class="validate"/>
									</td>
    	...
    	<!-- Authorize record -->
    	<logic:equal name="cartagemarster" property="action" value="authorize">
