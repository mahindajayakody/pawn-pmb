	...
	<head>
		...
		<script type="text/javascript">
			...
			function printDocument(){
				...
				if(branchId>0){	
					url = "trialbaloutstandingService.do?dispatch=print&reportName=/pawn/reports/trialBalanceOutstanding&headless=false"+
						  "&jpFromDate=" + $('fromDate').value + "&jpToDate=" + $('toDate').value + 
						  "&jpIntBranchId=" + $('branchId').value + "&jpUserName=" + userName + "&jpIntStatus=" + $('tiketstatus').value;	
						...
						<table class="InputTable">    
							...
							<tr>
								<td width="20%" align="right">
									<bean:message bundle="lable" key="screen.fromdate"/>&nbsp;
								</td>
								<td>
												...
												<table cellpadding="0" cellspacing="0">
													<tr>
														<td style="width: 140px" align="right">
															<bean:message bundle="lable" key="screen.todate"/>&nbsp;
														</td>
														<td>
