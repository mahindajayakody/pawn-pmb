...
<html:html>
  	<head>
		...
		<script type="text/javascript">
			...
			function getCreateData(){
				...
				return "&code=" + code + "&description=" + description + "&scheme=" + scheme;
			}
		...
		<style>
			#firstGrid {height: 400px;width:720px;}
			...
			#authorizeGrid {height: 400px;width:720px;}
  	...
  	<body onload="loadToolBar()">
    	...
    	<!-- Create record -->
    	<logic:equal name="product" property="action" value="create">
			<html:form action="productService.do">
										...
										<script>
			                                ...
			                                grid.onSelectedRowsChanged = function(row){	
			                                	if(row!='') { 
			                                		...
			                                		$('scheme').value      = grid.getCellText(2,row);
						...
						<td>							
							<table class="InputTable">    
								...
								<tr>
									...
									<td>
										<html:text property="code" styleId="code" size="5" maxlength="2"
											onfocus="clearDivision('divCode')" onblur="upperCase('code')"/>										
								...
								<tr>
									...
									<td>
										<html:text property="description" styleId="description" size="70" maxlength="60" 
								...
								<tr>
									...
									<td>
										<select id="scheme" name="scheme" style="width: 50px">
    	...
    	<!-- update record -->
    	<logic:equal name="product" property="action" value="update">
			<html:form action="productService.do">
				<input type="hidden" id="recordId" name="recordId"/>
				<input type="hidden" id="version" name="version"/>
						...
						<td>							
							<table class="InputTable">    
								...
								<tr>
									...
									<td>
										<html:text property="code" styleId="code" size="5" maxlength="2" disabled="true" styleClass="READONLYINPUT"
    	...
    	<!-- Delete record -->
    	<logic:equal name="product" property="action" value="delete">
			<html:form action="productService.do">
				<input type="hidden" id="recordId" name="recordId"/>
				<input type="hidden" id="version" name="version"/>
						...
						<td>							
							<table class="InputTable">    
								...
								<tr>
									...
									<td>
										<html:text property="description" styleId="description" size="70" maxlength="50" styleClass="READONLYINPUT" disabled="true" 
											onfocus="clearDivision('divDescription')"/>										
										<font color="red">*</font><br/>
										<div id="divDescription" class="validate"/>									
									</td>
								...
								<tr>
									...
									<td>
										<select id="scheme" name="scheme" style="width: 50px" class="READONLYINPUT" disabled="disabled">
											<option value="1">SH1</option>
											<option value="2">SH2</option>
										</select>
									</td>
    	...
    	<!-- Authorize record -->
    	<logic:equal name="product" property="action" value="authorize">
    		<html:form action="productService.do">
				<input type="hidden" id="recordId" name="recordId"/>
				<input type="hidden" id="version" name="version"/>
										...
										<script>
			                                ...
			                                grid.onSelectedRowsChanged = function(row){	
			                                	if(row!='') { 
			                                		...
			                                		$('scheme').value      	= grid.getCellText(3,row);
						...
						<td>							
							<table class="InputTable">    
								...
								<tr>
									...
									<td>
										<html:text property="code" styleId="code" size="5" maxlength="3" styleClass="READONLYINPUT" readonly="readonly"
											onfocus="clearDivision('divCode')"/>										
											<font color="red">*</font><br/>
											<div id="divCode" class="validate"/>
									</td>
								...
								<tr>
									...
									<td>
										<html:text property="description" styleId="description" size="70" maxlength="50" styleClass="READONLYINPUT" readonly="readonly"
											onfocus="clearDivision('divDescription')"/>										
										<font color="red">*</font><br/>
										<div id="divDescription" class="validate"/>
									</td>
