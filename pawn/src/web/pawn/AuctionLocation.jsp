...
<html:html>
  	<head>
		...
		<script type="text/javascript">
			...
			var url = 'auctionLocationService.do';
  	...
  	<body onload="loadToolBar()">
    	...
    	<!-- Create record -->
    	<logic:equal name="auctionlocation" property="action" value="create">
			<html:form action="auctionLocationService.do">
    	...
    	<!-- update record -->
    	<logic:equal name="auctionlocation" property="action" value="update">
			<html:form action="auctionLocationService.do">
				<input type="hidden" id="recordId" name="recordId"/>
				<input type="hidden" id="version" name="version"/>
    	...
    	<!-- Delete record -->
    	<logic:equal name="auctionlocation" property="action" value="delete">
			<html:form action="auctionLocationService.do">
				<input type="hidden" id="recordId" name="recordId"/>
				<input type="hidden" id="version" name="version"/>
    	...
    	<!-- Authorize record -->
    	<logic:equal name="auctionlocation" property="action" value="authorize">
			<html:form action="auctionLocationService.do">
				<input type="hidden" id="recordId" name="recordId"/>
				<input type="hidden" id="version" name="version"/>
