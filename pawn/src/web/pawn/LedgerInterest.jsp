...
<html:html>
	<head>
		<title>'LedgerInterest.jsp'</title>
			...
			function printDocument(){
				...
				if(branchId>0){	
					if(	fromDates.length == 0  || toDates.length == 0){
						...
						url = "pawningTransaction.do?dispatch=print&reportName=/pawn/reports/LedgerInterest&headless=false"+
	...
	<body>
		<h1 align="center">Ledger Interest Report</h1>
