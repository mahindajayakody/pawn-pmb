...
<html:html>
<head>
	<title>'BusinessTransaction.jsp'</title>
	<link rel="StyleSheet" type="text/css"
		href="<html:rewrite forward="commonCSS"/>"></link>
	<link rel="StyleSheet" type="text/css"
		href="<html:rewrite forward="awCSS"/>"></link>
	<link rel="StyleSheet" type="text/css"
		href="<html:rewrite forward="calendarCSS"/>"></link>
	...
	<script type="text/javascript"
		src="<html:rewrite forward="calendarJS"/>"></script>
	...
	<script type="text/javascript">
			...
			function printDocument(){
				...
				if(branchId>0){	
					url = "businessTransaction.do?dispatch=print&reportName=/pawn/reports/businessTransaction&headless=false"+
						  "&jpIntBranchId=" + branchId+"&jpAsAtDate=" + $('asAtDate').value;						   		
...
#firstGrid .aw-row-selector {
	text-align: center
}

#firstGrid .aw-column-0 {
	width: 120px;
}

#firstGrid .aw-column-1 {
	width: 555px;
}

#firstGrid .aw-grid-cell {
	border-right: 1px solid threedlightshadow;
}

#firstGrid .aw-grid-row {
...
<body>
	<h1 align="center">
		Pawning Business Transaction Summary Report
	</h1>
	<html:form action="businessTransaction.do">
	<input type="hidden" name="branchId" id="branchId">
					...
					<tr>
						...
						<td>
							<table cellpadding="0" cellspacing="0" width="100%">
								<tr>
									<td width="23%">
										<html:text property="asAtDate" size="15" maxlength="12" styleId="asAtDate" onkeypress="DateFormat(this,event);" onfocus="clearDivision('divasAtDate')" onkeyup="DateFormat(this,event);" /><img src="images/none.gif" width="5px" ><input type="button" value="..." onclick="return showCalendar('asAtDate');" />
										<font color="red">*</font><br/>
										<div id="divasAtDate" class="validate"/>
									</td>
								</tr>
							<tr height="2px"></tr>
		...
		<table class="toolTable" id="toolbar">
			<tr>
				<td align="center">
					<input type='button'
						value="<bean:message bundle="button" key="button.print"/> "
						class="buttonNormal" id="Print" onclick="printDocument()" />
				</td>
			</tr>
		</table>
	</html:form>
