...
<html:html>
  	...
  	<body onload="loadToolBar()">
    	...
    	<!-- Create record -->
    	<logic:equal name="location" property="action" value="create">
			<html:form action="locationService.do">
    	...
    	<!-- update record -->
    	<logic:equal name="location" property="action" value="update">
			<html:form action="locationService.do">
				<input type="hidden" id="recordId" name="recordId"/>
				<input type="hidden" id="version" name="version"/>
    	...
    	<!-- Delete record -->
    	<logic:equal name="location" property="action" value="delete">
			<html:form action="locationService.do">
				<input type="hidden" id="recordId" name="recordId"/>
				<input type="hidden" id="version" name="version"/>
    	...
    	<!-- Authorize record -->
    	<logic:equal name="location" property="action" value="authorize">
			<html:form action="locationService.do">
				<input type="hidden" id="recordId" name="recordId"/>
				<input type="hidden" id="version" name="version"/>
						...
						<td>							
							<table class="InputTable">    
								...
								<tr>
									...
									<td>
										<html:text property="description" styleId="description" size="70" maxlength="50" disabled="true" styleClass="READONLYINPUT"
											onfocus="clearDivision('divDescription')"/>										
										<font color="red">*</font><br/>
										<div id="divDescription" class="validate"/>
									</td>
