...
<html:html>
	<head>
		...
		<script type="text/javascript">								
			...
			function getTicketData(){
				data = "dispatch=getAjaxData&ticketId=" + $('ticketId').value + "&receiptType=2" ;
			...
			function validateAmt(){
				...
				if(receiptamt>TotDueAmt && TotDueAmt>0){
					alert ('Receipt amount connot be Grater than Total Due amount.');
					return false;
				}
				return true;
			}
	...
	<body>
		...
		<!-- Create record -->
		<logic:equal name="waiveoff" property="action" value="create">
							...
							<table class="InputTable">
								...
								<tr>
									<td width="20%" align="right">
										<bean:message bundle="lable" key="screen.waivereceiptno" />&nbsp;
									</td>
									<td>									
					...
					<tr>
						<td>
							<table class="InputTable">
								...
								<tr>
									<td width="20%" align="right">
										<bean:message bundle="lable" key="screen.waivereceiptamt" />&nbsp;
									</td>
									<td>
