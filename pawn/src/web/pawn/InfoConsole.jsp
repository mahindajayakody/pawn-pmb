...
<html:html>
	...
	<body>
		...
		<logic:equal name="infoconsole" property="action" value="create">
											...
											<tr>
												<td width="35%">
													...
													<html:text property="ticketNumber" styleId="ticketNumber" size="20"	maxlength="13"
														...
														onblur="upperCase('ticketNumber');commonSearch('infoconsoleService.do','ticketId','ticketNumber','ticketId','getTicketWithoutStatus','divTicketno',function(){getInfoData();},'',function(){clearOtherData();})"/>
			...
			<jsp:include flush="true" page="InfoTicketBrowser.jsp"></jsp:include>
		</logic:equal>
