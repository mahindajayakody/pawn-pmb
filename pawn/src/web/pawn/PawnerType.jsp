...
<html:html>
  	...
  	<body onload="loadToolBar()">
    	...
    	<!-- Create record -->
    	<logic:equal name="pawnertype" property="action" value="create">
			<html:form action="pawnerTypeService.do">
    	...
    	<!-- update record -->
    	<logic:equal name="pawnertype" property="action" value="update">
			<html:form action="pawnerTypeService.do">
				<input type="hidden" id="recordId" name="recordId"/>
				<input type="hidden" id="version" name="version"/>
    	...
    	<!-- Delete record -->
    	<logic:equal name="pawnertype" property="action" value="delete">
			<html:form action="pawnerTypeService.do">
				<input type="hidden" id="recordId" name="recordId"/>
				<input type="hidden" id="version" name="version"/>
    	...
    	<!-- Authorize record -->
    	<logic:equal name="pawnertype" property="action" value="authorize">
    		<html:form action="pawnerTypeService.do">
				<input type="hidden" id="recordId" name="recordId"/>
				<input type="hidden" id="version" name="version"/>
