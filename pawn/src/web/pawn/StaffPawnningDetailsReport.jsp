...
<html:html>
	<head>
		<title>'Staff Pawnning Report.jsp'</title>
		...
		<script type="text/javascript">
			...
			function printDocument(){
		    	...
		    	url = "StaffPawnning.do?dispatch=print&reportName=/pawn/reports/staffPawn&headless=false" + "&jpUserName=" + userName;
				theHeight=500;
				theWidth=800;
	...
	<body >
		<h1 align="center">Staff Pawnning Report</h1>
