...
<html:html>
	<head>
		<title>'DailyPaymentReport.jsp'</title>
		...
		<script type="text/javascript">
			...
			function printDocument(){
				...
				if(branchId>0){		   		
			    	url = "dailypaymentreportService.do?dispatch=print&rand=" + Math.random()*9999999 + "&branchId=" + branchId +
	...
	<body>
		<html:form action="dailypaymentreportService.do">
