...
<html:html>
	<head>
		...
		<script type="text/javascript">
			...
			function printDocument(){
				...
				if(branchId>0){	
					url = "auctionTicket.do?dispatch=print&reportName=/pawn/reports/auctionTickets&headless=false"+
						  "&jpFromDate=" + $('fromDate').value + "&jpToDate=" + $('toDate').value + 
						  "&jpIntBranchId=" + $('branchId').value + "&jpUserName=" + userName;	
	...
	<body>
		<h1 align="center">Auction Ticket Report</h1>
		<html:form action="auctionTicket.do">
